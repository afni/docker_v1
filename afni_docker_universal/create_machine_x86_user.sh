...
## user level install for afni docker on x86
...
tcsh @update.afni.binaries -no_recur -package linux_ubuntu_24_64 \
...
curl -O https://afni.nimh.nih.gov/pub/dist/tgz/package_libs/linux_ubuntu_24_R-${rver}_libs.tgz
tar -xvzf linux_ubuntu_24_R-${rver}_libs.tgz
mv linux_ubuntu_24_R-${rver}_libs /home/afni_user/R
rm -f linux_ubuntu_24_R-${rver}_libs.tgz
